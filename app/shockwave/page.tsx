    ...
    <main className="flex-1 flex flex-col gap-12 items-center w-full mx-auto py-12 lg:py-24">
      ...
      <section className="flex flex-col gap-8 xl:hidden w-full">
        <div className="flex w-full">
          ...
          <h2 className="flex-10 md:flex-6 flex justify-center items-center h-16 px-8 md:px-16 py-2 md:py-4 text-center bg-[var(--secondary)] text-white text-xl md:text-2xl lg:text-3xl font-bold">
            Shockwave Therapy
          </h2>
          <div className="flex-3 md:flex-6 flex items-center h-16">
            <div className="w-full h-4 bg-[var(--primary)]" />
          </div>
        </div>
        ...
        <p className="w-4/5 lg:w-3/5 mx-auto px-8 py-4 bg-[var(--secondary)] text-sm md:text-base lg:text-lg text-center text-white">
          Shockwave therapy is the process of using high energy sound waves to
          treat soft-tissue injuries. By impacting specific tissues, shockwaves
          can break down scar tissue, promote tissue healing and blood flow,
          reduce inflammation, and increase local healing responses. It is
          especially effective for healing injuries to muscles, tendons,
          ligaments, and the plantar fascia of the feet.
        </p>
      </section>
